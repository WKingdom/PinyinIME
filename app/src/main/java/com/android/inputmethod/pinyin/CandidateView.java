...
public class CandidateView extends View {
     ...
     */
    private static final float MIN_ITEM_WIDTH = 60;
    ...
    private int mImeCandidateBallColor;
...
//        mActiveCellDrawable = r.getDrawable(R.drawable.candidate_hl_bg);
        mActiveCellDrawable = new ColorDrawable(r.getColor(R.color.candidate_bg_color_hl));
        ...
        mImeCandidateBallColor = r.getColor(R.color.candidate_ball_color);
    ...
    private void showBalloon(int candPos, boolean delayedShow) {
        ...
        mBalloonHint.setBalloonConfig(mDecInfo.mCandidatesList
                ...
                mImeCandidateBallColor, desired_width, desired_height);
